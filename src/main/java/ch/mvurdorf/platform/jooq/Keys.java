...
public class Keys {
    ...
    public static final UniqueKey<NotenShareLinkRecord> NOTEN_SHARE_LINK_PKEY = Internal.createUniqueKey(NotenShareLink.NOTEN_SHARE_LINK, DSL.name("noten_share_link_pkey"), new TableField[] { NotenShareLink.NOTEN_SHARE_LINK.ID }, true);
    public static final UniqueKey<NotenShareLinkRecord> NOTEN_SHARE_LINK_TOKEN_KEY = Internal.createUniqueKey(NotenShareLink.NOTEN_SHARE_LINK, DSL.name("noten_share_link_token_key"), new TableField[] { NotenShareLink.NOTEN_SHARE_LINK.TOKEN }, true);
    ...
    public static final ForeignKey<NotenShareLinkRecord, KonzertRecord> NOTEN_SHARE_LINK__NOTEN_SHARE_LINK_FK_KONZERT_FKEY = Internal.createForeignKey(NotenShareLink.NOTEN_SHARE_LINK, DSL.name("noten_share_link_fk_konzert_fkey"), new TableField[] { NotenShareLink.NOTEN_SHARE_LINK.FK_KONZERT }, Keys.PK__KONZERT, new TableField[] { Konzert.KONZERT.ID }, true);
    ...
    public static final ForeignKey<ShareableLinkInstrumentRecord, ShareableLinkRecord> SHAREABLE_LINK_INSTRUMENT__FK__SHAREABLE_LINK_INSTRUMENT_LINK = Internal.createForeignKey(ShareableLinkInstrument.SHAREABLE_LINK_INSTRUMENT, DSL.name("fk__shareable_link_instrument_link"), new TableField[] { ShareableLinkInstrument.SHAREABLE_LINK_INSTRUMENT.SHAREABLE_LINK_ID }, Keys.PK__SHAREABLE_LINK, new TableField[] { ShareableLink.SHAREABLE_LINK.ID }, true);
