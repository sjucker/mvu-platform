...
public class Keys {
    ...
    public static final UniqueKey<LoginRecord> UQ__LOGIN__CALENDAR_TOKEN = Internal.createUniqueKey(Login.LOGIN, DSL.name("uq__login__calendar_token"), new TableField[] { Login.LOGIN.CALENDAR_TOKEN }, true);
    ...
    public static final UniqueKey<ShareableLinkRecord> PK__SHAREABLE_LINK = Internal.createUniqueKey(ShareableLink.SHAREABLE_LINK, DSL.name("pk__shareable_link"), new TableField[] { ShareableLink.SHAREABLE_LINK.ID }, true);
    public static final UniqueKey<ShareableLinkRecord> UQ__SHAREABLE_LINK = Internal.createUniqueKey(ShareableLink.SHAREABLE_LINK, DSL.name("uq__shareable_link"), new TableField[] { ShareableLink.SHAREABLE_LINK.UUID }, true);
    public static final UniqueKey<ShareableLinkInstrumentRecord> PK__SHAREABLE_LINK_INSTRUMENT = Internal.createUniqueKey(ShareableLinkInstrument.SHAREABLE_LINK_INSTRUMENT, DSL.name("pk__shareable_link_instrument"), new TableField[] { ShareableLinkInstrument.SHAREABLE_LINK_INSTRUMENT.ID }, true);
    public static final UniqueKey<ShareableLinkKompositionRecord> PK__SHAREABLE_LINK_NOTEN = Internal.createUniqueKey(ShareableLinkKomposition.SHAREABLE_LINK_KOMPOSITION, DSL.name("pk__shareable_link_noten"), new TableField[] { ShareableLinkKomposition.SHAREABLE_LINK_KOMPOSITION.ID }, true);
    ...
    public static final ForeignKey<AbsenzStatusRecord, EventRecord> ABSENZ_STATUS__FK__ABSENZ_STATUS_EVENT = Internal.createForeignKey(AbsenzStatus.ABSENZ_STATUS, DSL.name("fk__absenz_status_event"), new TableField[] { AbsenzStatus.ABSENZ_STATUS.FK_EVENT }, Keys.PK__EVENT, new TableField[] { Event.EVENT.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<AbsenzStatusRecord, LoginRecord> ABSENZ_STATUS__FK__ABSENZ_STATUS_LOGIN = Internal.createForeignKey(AbsenzStatus.ABSENZ_STATUS, DSL.name("fk__absenz_status_login"), new TableField[] { AbsenzStatus.ABSENZ_STATUS.FK_LOGIN }, Keys.PK__LOGIN, new TableField[] { Login.LOGIN.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<EventRecord, EventRecord> EVENT__FK__EVENT_VERSION = Internal.createForeignKey(Event.EVENT, DSL.name("fk__event_version"), new TableField[] { Event.EVENT.NEXT_VERSION }, Keys.PK__EVENT, new TableField[] { Event.EVENT.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<KonzertEntryRecord, KompositionRecord> KONZERT_ENTRY__KONZERT_ENTRY_FK_KOMPOSITION_FKEY = Internal.createForeignKey(KonzertEntry.KONZERT_ENTRY, DSL.name("konzert_entry_fk_komposition_fkey"), new TableField[] { KonzertEntry.KONZERT_ENTRY.FK_KOMPOSITION }, Keys.PK__KOMPOSITION, new TableField[] { Komposition.KOMPOSITION.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<KonzertEntryRecord, KonzertRecord> KONZERT_ENTRY__KONZERT_ENTRY_FK_KONZERT_FKEY = Internal.createForeignKey(KonzertEntry.KONZERT_ENTRY, DSL.name("konzert_entry_fk_konzert_fkey"), new TableField[] { KonzertEntry.KONZERT_ENTRY.FK_KONZERT }, Keys.PK__KONZERT, new TableField[] { Konzert.KONZERT.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<NotenPdfRecord, KompositionRecord> NOTEN_PDF__NOTEN_FK_KOMPOSITION_FKEY = Internal.createForeignKey(NotenPdf.NOTEN_PDF, DSL.name("noten_fk_komposition_fkey"), new TableField[] { NotenPdf.NOTEN_PDF.FK_KOMPOSITION }, Keys.PK__KOMPOSITION, new TableField[] { Komposition.KOMPOSITION.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<NotenPdfAssignmentRecord, NotenPdfRecord> NOTEN_PDF_ASSIGNMENT__FK__NOTEN_PDF_ASSIGNMENT = Internal.createForeignKey(NotenPdfAssignment.NOTEN_PDF_ASSIGNMENT, DSL.name("fk__noten_pdf_assignment"), new TableField[] { NotenPdfAssignment.NOTEN_PDF_ASSIGNMENT.FK_NOTEN_PDF }, Keys.PK__NOTEN, new TableField[] { NotenPdf.NOTEN_PDF.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    ...
    public static final ForeignKey<ShareableLinkInstrumentRecord, ShareableLinkRecord> SHAREABLE_LINK_INSTRUMENT__FK__SHAREABLE_LINK_INSTRUMENT_LINK = Internal.createForeignKey(ShareableLinkInstrument.SHAREABLE_LINK_INSTRUMENT, DSL.name("fk__shareable_link_instrument_link"), new TableField[] { ShareableLinkInstrument.SHAREABLE_LINK_INSTRUMENT.SHAREABLE_LINK_ID }, Keys.PK__SHAREABLE_LINK, new TableField[] { ShareableLink.SHAREABLE_LINK.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ShareableLinkKompositionRecord, KompositionRecord> SHAREABLE_LINK_KOMPOSITION__FK__SHAREABLE_LINK_KOMPOSITION_KOMP = Internal.createForeignKey(ShareableLinkKomposition.SHAREABLE_LINK_KOMPOSITION, DSL.name("fk__shareable_link_komposition_komp"), new TableField[] { ShareableLinkKomposition.SHAREABLE_LINK_KOMPOSITION.KOMPOSITION_ID }, Keys.PK__KOMPOSITION, new TableField[] { Komposition.KOMPOSITION.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
