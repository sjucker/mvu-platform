...
public class Login extends TableImpl<LoginRecord> {
    ...
    /**
     * The column <code>public.login.absenzen_permission</code>.
     */
    public final TableField<LoginRecord, String> ABSENZEN_PERMISSION = createField(DSL.name("absenzen_permission"), SQLDataType.VARCHAR(255).nullable(false).defaultValue(DSL.field(DSL.raw("'NONE'::character varying"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>public.login.register</code>.
     */
    ...
    /**
     * The column <code>public.login.calendar_token</code>.
     */
    public final TableField<LoginRecord, String> CALENDAR_TOKEN = createField(DSL.name("calendar_token"), SQLDataType.VARCHAR(36).nullable(false), this, "");
    ...
    public List<UniqueKey<LoginRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.UQ__LOGIN__CALENDAR_TOKEN, Keys.UQ__LOGIN_EMAIL);
    }
    ...
    public Login where(Condition condition) {
        return new Login(getQualifiedName(), aliased() ? this : null, null, Internal.condition(this, condition));
    }
     ...
     */
    @Override
    public Login whereExists(TableLike<?> select) {
     ...
     */
    @Override
    public Login whereNotExists(TableLike<?> select) {
