...
public class SupporterVoucher extends TableImpl<SupporterVoucherRecord> {
     ...
     */
    public final TableField<SupporterVoucherRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false), this, "");
    ...
    public SupporterVoucher where(Condition condition) {
        return new SupporterVoucher(getQualifiedName(), aliased() ? this : null, null, Internal.condition(this, condition));
    }
     ...
     */
    @Override
    public SupporterVoucher whereExists(TableLike<?> select) {
     ...
     */
    @Override
    public SupporterVoucher whereNotExists(TableLike<?> select) {
