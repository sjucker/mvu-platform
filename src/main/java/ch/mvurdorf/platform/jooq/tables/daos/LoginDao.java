...
public class LoginDao extends AbstractSpringDAOImpl<LoginRecord, ch.mvurdorf.platform.jooq.tables.pojos.Login, Long> {
    ...
    /**
     * Fetch records that have <code>calendar_token BETWEEN lowerInclusive AND
     * upperInclusive</code>
     */
    public List<ch.mvurdorf.platform.jooq.tables.pojos.Login> fetchRangeOfCalendarToken(String lowerInclusive, String upperInclusive) {
        return fetchRange(Login.LOGIN.CALENDAR_TOKEN, lowerInclusive, upperInclusive);
    }

    /**
     * Fetch records that have <code>calendar_token IN (values)</code>
     */
    public List<ch.mvurdorf.platform.jooq.tables.pojos.Login> fetchByCalendarToken(String... values) {
        return fetch(Login.LOGIN.CALENDAR_TOKEN, values);
    }

    /**
     * Fetch a unique record that has <code>calendar_token = value</code>
     */
    public ch.mvurdorf.platform.jooq.tables.pojos.Login fetchOneByCalendarToken(String value) {
        return fetchOne(Login.LOGIN.CALENDAR_TOKEN, value);
    }

    /**
     * Fetch a unique record that has <code>calendar_token = value</code>
     */
    public Optional<ch.mvurdorf.platform.jooq.tables.pojos.Login> fetchOptionalByCalendarToken(String value) {
        return fetchOptional(Login.LOGIN.CALENDAR_TOKEN, value);
    }
}
