...
public class Login implements Serializable {
    ...
    public Login(Login value) {
        ...
        this.calendarToken = value.calendarToken;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.calendarToken == null) {
            if (other.calendarToken != null)
                return false;
        } else if (!this.calendarToken.equals(other.calendarToken))
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((this.calendarToken == null) ? 0 : this.calendarToken.hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(", ").append(calendarToken);
